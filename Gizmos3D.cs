...
public partial class Gizmos3D : Node
{

    //TODO: This should have a local list of all lines so it can just update existing lines
    //rather than create it every frame?
    //Maybe?
