...
/// distance to something to be important, this can also be layered together linearly/averaged.
/// 
/// for example if you have 4 players, you can do this 4 times, then layer the fields together
/// the directions and distances will change if they're weighted by the distance, and so the layered field
/// would generally tell you the distance to the closest player.
/// 
